...
# n.crisisops - LGPD Privacy Module - Deploy Atualizado para VPS
# Script otimizado para deploy em produção

set -e  # Exit on any error

echo "🚀 n.crisisops - LGPD Privacy Module - Deploy Atualizado"
echo "================================================================="
...
REPO_URL="https://github.com/seu-usuario/IncidentResponse-Privacy.git"
...
mkdir -p $INSTALL_DIR/{uploads,backups,logs,data,static}
...
ExecStart=/opt/privacy/venv/bin/gunicorn --config gunicorn.conf.py web_interface_enhanced:app
Restart=always
RestartSec=5
